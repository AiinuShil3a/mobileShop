...
<head>
    ...
    <link href="assets/css/cssview.css" rel="stylesheet" />
...
<body>
                            ...
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        <div class="text-center">
                                            ...
                                            <p class="mt-1 mb-5 pb-1">WELCOME TO WEBSITE SHIL3AIINU</p>
                                        </div>
                                        <center>
                                ...
                                <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                        ...
                                        <h4 class="small mb-0">- ทำตามกฎอย่างเข่งคัด !</h4><br>
                                        <h4 class="small mb-0">- ห้ามนำไปเผยแพร่ที่อื่น !</h4><br>
                                        <h4 class="small mb-0">- หากพบปัญหาติดต่ออเจ้าหน้าที่</h4>
                                        <h4 class="small mb-0">- โปรดใช้วิจารณาในการเลือกซื้อสินค้า</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- ======= selectGrade Section ======= -->
    <section id="selectGrade" class="d-flex flex-column justify-content-center">
        <div class="container" data-aos="zoom-in" data-aos-delay="100">
            <div class="container-fluid h-custom">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <?php
                        include "controller/showmobile.php";
                    ?>
                </div>
            </div>
        </div>
