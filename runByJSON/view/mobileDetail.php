                            ...
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        <div class="text-center">
                                            ...
                                            <img src="../assets/img/<?=$rs2[$BasicCode]->imgMobile;?>" alt="..." width="350" height="250"/>
                                        </div>
                                        <br><br>
                                        <center>
                                        <nav id="navbar" class="navbar nav-menu">
                                ...
                                <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                        <h4 class="mb-4">Detail : <?=$rs2[$BasicCode]->nameMobile;?></h4>
                                        <h4 class="small mb-0">-รุ่นมือถือ <?=$rs2[$BasicCode]->osMobile;?></h4><br>
                                        <h4 class="small mb-0">-ความเร็ว <?=$rs2[$BasicCode]->ramMobile;?></h4><br>
                                        <h4 class="small mb-0">-แบตเตอรี่ <?=$rs2[$BasicCode]->batterryMobile;?></h4><br>
                                        <h4 class="small mb-0">-ราคา <?=$rs2[$BasicCode]->seleMobile;?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
